...
def app():
    ...
    st.markdown("Choose a page in the `sidebar` to get started")

    # Insert video walkthrough here!


    # Read Me expander section
    about_expander = st.beta_expander("Read me")
    ...
    * 👨‍💻 Domenic Fayad: [LinkedIn](https://www.linkedin.com/in/domenicfayad/ "Domenic's LinkedIn"), [Twitter](https://twitter.com/DomenicFayad "Domenic's Twitter"), [Github](https://github.com/dmf95 "Domenic's Github"), & [Personal analytics blog](https://www.fullstaxx.com/ "Full Staxx Analytics Blog")
    * 👩‍💻 Shannon Lo: [LinkedIn](https://www.linkedin.com/in/shannonhlo/ "Shannon's LinkedIn"), [Twitter](https://twitter.com/shannonhlo26 "Shannon's Twitter"), [Github](https://github.com/shannonhlo "Shannon's Github"), & [Portfolio](https://shannonhlo.github.io/ "Shannon's Analytics Portfolio")
